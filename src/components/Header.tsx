      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center gap-8 lg:gap-10">
            ...
            {/* Desktop Navigation Links - Bold Uppercase Tracking-widest */}
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="relative group">
              <select
                ...
                className="bg-[#1a1a1a] border border-white/20 rounded-lg px-3 py-1.5 text-xs sm:text-sm font-bold uppercase tracking-wider text-white outline-none cursor-pointer hover:border-[#7c3aed] transition-colors appearance-none pr-8"
              >
              ...
              <span className="material-icons text-xs text-white/50 absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none">
                expand_more
              </span>
            </div>
            ...
            {user?.isAdmin && (
              <button
                ...
                type="button"
                onClick={onOpenAdmin}
                className="hidden sm:flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#7c3aed]/20 border border-[#7c3aed] hover:bg-[#7c3aed] text-white text-xs font-bold uppercase tracking-wider transition-all shadow-md cursor-pointer"
            ...
            {user ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 p-1.5 rounded-full bg-white/5 border border-white/10 hover:border-[#7c3aed] transition-colors cursor-pointer"
                >
                  <img
                  ...
                  />
                  <span className="material-icons text-xs text-white/50">
                    expand_more
                  </span>
                </button>
              ...
              <button
                ...
                className="flex items-center gap-2 bg-white/5 border border-white/10 hover:border-[#7c3aed] px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider text-white transition-all cursor-pointer shrink-0"
              >
                {/* Google "G" Icon */}
            ...
            <div className="relative">
              <button
                ...
                type="button"
                onClick={onOpenCart}
                className="p-2 hover:bg-white/10 rounded-full relative flex items-center justify-center cursor-pointer transition-colors text-white"
                title="Корзина"
              >
                ...
                {cartCount > 0 && (
                  <span
                    ...
                    className="absolute top-0 right-0 bg-[#7c3aed] text-[10px] w-4 h-4 flex items-center justify-center rounded-full font-bold shadow-md shadow-[#7c3aed]/50 animate-in zoom-in"
                  >
                    {cartCount}
                  </span>
                )}
            ...
            <button
              ...
              className="md:hidden p-2 rounded-lg bg-white/5 border border-white/10 text-neutral-300 hover:text-white"
            >
